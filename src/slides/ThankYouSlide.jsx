    ...
    <Slide index={index} className={styles.thankYou}>
      ...
      <div className={`${styles.body} content-frame content-gutter`}>
        <div className={styles.content}>
          <Editable as="h1" id="thankYou.title" className={styles.title}>
            Thank You
          </Editable>
          ...
          <div className={styles.logos}>
            ...
            <svg className={styles.logo} viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" aria-label="GitHub">
      ...
      <BottomBar text={<Editable as="span" id="thankYou.footer">Flender DevDays</Editable>} />
    </Slide>
  )
}
